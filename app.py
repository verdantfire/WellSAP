...
def result():
    if request.method == "POST":
        if request.form.get("employee_id") != None:
            ...
            print(results)
            #return render_template('result.html', wellness_score=
            ...
            return render_template('result.html', wellness_score=data["employee_name"],personal_wellness_score=last_name,workplace_wellness_score=12,subjective_wellness_score=13, sub_score_1=None, sub_score_2=None, sub_score_3=None)
